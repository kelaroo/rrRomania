...
public class AutonomaAlbastruDreaptaSimplu extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(ringsNumber == NONE) { // A
            ...
            drive.turn(Math.toRadians(-83.0));
...
/*
            ...
            Trajectory trajC2 =  myTrajectoryBuilder(trajC12.end(), 5, 15)
                    .forward(12)
                    .build();
            Trajectory trajC3 = myTrajectoryBuilder(trajC2.end(), 5, 15)
                    .forward(14.0)
                    .build();
            ...
            Trajectory trajC4 = myTrajectoryBuilder(trajC3.end().plus(new Pose2d(0,0,Math.toRadians(-10.5))), 60, 60)
                    ...
                    .addTemporalMarker(0.7, ()->{sisteme.bratWobble.setPosition(BRAT_JOS);})
                    .addTemporalMarker(0.3, ()->{intakeOn();})
                    .build();
            ...
            sleep(400);shoot();sleep(300);shoot();sleep(300);shoot();
            ...
            sisteme.lansat.setVelocity(LANSAT_BLUES_C2);
