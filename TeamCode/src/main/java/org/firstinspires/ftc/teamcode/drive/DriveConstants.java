...
public class DriveConstants {
    ...
    /*public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(10, 0.1, 5,
            13); //getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV));*/
    ...
    public static double TRACK_WIDTH = 17.4; //13.6; // in //17.4
    ...
    public static double kStatic = 0.12417;
