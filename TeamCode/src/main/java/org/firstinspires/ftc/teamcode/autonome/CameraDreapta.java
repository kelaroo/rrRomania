...
public class CameraDreapta {
    ...
    public CameraDreapta(HardwareMap hw) {
        int cameraMonitorViewId = hw.appContext.getResources().getIdentifier("cameraMonitorViewId", "id", hw.appContext.getPackageName());
        webcam = OpenCvCameraFactory.getInstance().createWebcam(hw.get(WebcamName.class, "Webcam 2"), cameraMonitorViewId);
    ...
    public static class RingsDetectionPipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            Rect cropRect = new Rect(169, 26, 147, 102);
        ...
        public static RingsNumber getNumberOfRings() {return ringsNumber;}
