    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(ringsNumber == NONE) { // A
            ...
            Trajectory trajA3 = drive.trajectoryBuilder(trajA21.end().plus(new Pose2d(0.0, 0.0, Math.toRadians(-90.0))))
                    .lineToConstantHeading(new Vector2d(-37.2, -19.5))
            ...
            Trajectory trajB2 = drive.trajectoryBuilder(trajB12.end().plus(new Pose2d(0.0, 0.0, Math.toRadians(-7.0))))
                    .forward(18.0)
                    .build();

            // lasa wobble
            Trajectory trajB3 = drive.trajectoryBuilder(trajB2.end().plus(new Pose2d(0.0, 0.0, Math.toRadians(0.0))))
                    .lineToLinearHeading(new Pose2d(35.0, -40.0, Math.toRadians(180.0)))
            ...
            Trajectory trajB4 = drive.trajectoryBuilder(trajB3.end())
                    .lineToLinearHeading(new Pose2d(-36.3, -17.5, Math.toRadians(0.0)))
            ...
            Trajectory trajB5 = drive.trajectoryBuilder(trajB4.end())
                    .lineToLinearHeading(new Pose2d(24.0, -47.0, Math.toRadians(180.0)))
                    .build();
            ...
            Trajectory trajC5 = myTrajectoryBuilder(trajC4.end(), 60.0, 60.0)
                    .lineToConstantHeading(new Vector2d(-24.0, -16.0))
                    .build();
