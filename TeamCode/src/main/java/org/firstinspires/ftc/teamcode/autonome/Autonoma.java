    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(ringsNumber == NONE) { // A
            ...
            Trajectory trajA3 = drive.trajectoryBuilder(trajA2.end().plus(new Pose2d(0.0, 0.0, Math.toRadians(-90.0))))
                    .lineToConstantHeading(new Vector2d(-38.0, -20))
                    .addTemporalMarker(0.5, ()->{ sisteme.bratWobble.setPosition(BRAT_JOS); })
                    .build();
            ...
            Trajectory trajB4 = drive.trajectoryBuilder(trajB3.end())
                    .lineToLinearHeading(new Pose2d(-37.3, -19.0, Math.toRadians(0.0)))
            ...
            Trajectory trajC1 = drive.trajectoryBuilder(startPose)
                    ...
                    .addTemporalMarker(0.5, ()->{ sisteme.cuva.setPosition(CUVA_SUS); })
                    .build();
            Trajectory trajC2 = myTrajectoryBuilder(trajC1.end().plus(new Pose2d(0,0,Math.toRadians(9))), 60, 70)
                    .forward(20.0)
                    .addTemporalMarker(0, ()->{
                        sisteme.cuva.setPosition(CUVA_JOS);
                        intakeOn();
                    ...
                    .build();
            /*Trajectory trajC3 = myTrajectoryBuilder(trajC2.end(), 30, 20)
                    .forward(10.0)
                    .build();
            Trajectory trajC31 = myTrajectoryBuilder(trajC3.end(), 30, 20)
                    .back(5)
                    .build();
            Trajectory trajC32 = myTrajectoryBuilder(trajC31.end(), 30, 20)
                    .forward(20.0)
                    .build();*/
            Trajectory trajC3 = myTrajectoryBuilder(trajC2.end(), 20, 15)
                    .splineToConstantHeading(new Vector2d(-29.0, -35.0), Math.toRadians(180.0))
                    .build();
            Trajectory trajC31 = myTrajectoryBuilder(trajC3.end(), 20, 15)
                    .forward(6.5)
                    .build();
            Trajectory trajC4 = myTrajectoryBuilder(trajC31.end().plus(new Pose2d(0,0,Math.toRadians(-12.0))), 60, 60)
            ...
            Trajectory trajC5 = myTrajectoryBuilder(trajC4.end(), 60.0, 60.0)
                    .lineToConstantHeading(new Vector2d(-24.0, -18.0))
                    .build();
            ...
            drive.followTrajectory(trajC2);
            drive.followTrajectory(trajC3);
            drive.followTrajectory(trajC31);
            //drive.followTrajectory(trajC32);
            sisteme.cuva.setPosition(CUVA_SUS);
            sleep(300);

            drive.turn(Math.toRadians(-12.0));
            shoot(); shoot(); shoot();
            sisteme.lansat.setPower(0);
